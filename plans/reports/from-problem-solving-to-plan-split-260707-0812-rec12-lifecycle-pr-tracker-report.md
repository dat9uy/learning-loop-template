...
- **Branch / PR:** `rec12-closed-loop` (off main @ `a7da7fb`, post-PR-#40) / PR #41 (squash `96bdf34`)
- **Status:** `SHIPPED` (PR #41 merged 2026-07-08; change-log gap detection + session-start surfacing shipped; SessionEnd/pre-commit hook UQ5 un-blocked)
- **Dates:** cut 2026-07-08 / cook-start 2026-07-08 / shipped 2026-07-08
