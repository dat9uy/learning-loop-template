...
### M2. ~~`docs/registry-summary.md` is committed to git but auto-generated~~ — RESOLVED
...
**Fix applied (2026-06-07, post-review):** Operator chose option (a) — added to `.gitignore` (line 19) with a comment explaining the rationale; ran `git rm --cached docs/registry-summary.md` to untrack the existing committed copy. The file is still generated by `meta_state_sweep` on every apply; it just no longer causes merge conflicts.

**What changed:**
- `.gitignore` line 19: `docs/registry-summary.md` (with comment "Auto-generated by meta_state_sweep (M2 resolution): never edited by humans")
- `git rm --cached docs/registry-summary.md` — file removed from git index, but kept on disk (operator can re-generate on next sweep)

**Verification:**
- `git check-ignore -v docs/registry-summary.md` → `.gitignore:19:docs/registry-summary.md` (exit 0)
