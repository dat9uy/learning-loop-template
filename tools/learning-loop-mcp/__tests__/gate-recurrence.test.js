...
import { gateCheckRecurrenceTool } from "../tools/gate-check-recurrence-tool.js";
...
await test("SessionStart hook runs checkAndEmit and exits 0", () => {
  ...
  const wrapper = new URL("../hooks/recurrence-check-on-start.js", import.meta.url).pathname;
