...
// 1. Manifest has 40 entries (all product-surface tools deleted + 3 new gate/tools)
await test("manifest has 40 entries", () => {
  assert.strictEqual(manifest.length, 40, `Expected 40, got ${manifest.length}`);
});
