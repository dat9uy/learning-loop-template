...
async function seedRegistry(root) {
  ...
  await writeEntry(root, {
    ...
    change_target: "tools/learning-loop-mastra/core/legacy/gate-logic.js#applyPromotedRules",
    ...
    evidence_code_ref: "tools/learning-loop-mastra/core/legacy/gate-logic.js#applyPromotedRules",
    status: "active",
  ...
  for (const [idx, id] of [[1, finding1Id], [2, finding2Id], [3, finding3Id]]) {
    await writeEntry(root, {
      ...
      evidence: { code_ref: "tools/learning-loop-mastra/core/legacy/gate-logic.js#applyPromotedRules" },
      status: "superseded",
  ...
  test("cold tier excludes entries without consolidated_into", async () => {
    ...
    try {
      ...
      await writeEntry(root, {
        ...
        evidence: { code_ref: "tools/learning-loop-mastra/core/legacy/gate-logic.js" },
        status: "superseded",
