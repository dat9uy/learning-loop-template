/**
 * Cold-source coverage test: every active agent-checklist rule must have a
 ...
 * contributor who promotes a agent-checklist rule and forgets the
...
test("every active agent-checklist rule has a matching PROCESS_HINTS row (H6 cold-source guard)", () => {
  ...
  assert.deepStrictEqual(
    missing,
    [],
    `Each agent-checklist rule must appear as a substring in some PROCESS_HINTS row. ` +
