...
test("cold-tier regression: structural invariants, no fixture dependency", async () => {
  ...
  const terminalStatuses = new Set(["resolved", "superseded", "accepted", "archived"]);
  ...
  const selfPath = resolveEvidencePath("tools/learning-loop-mastra/__tests__/integration/cold-tier-regression.test.js");
