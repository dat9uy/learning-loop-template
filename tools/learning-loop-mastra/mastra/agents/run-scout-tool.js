/**
 * createTool wrapper over tools/learning-loop-mastra/scout/legacy/run-scout.js#runScout.
...
export const runScoutTool = createLoopTool({
  id: "run_scout",
  description:
    "Run the scout pipeline at tools/learning-loop-mastra/scout/legacy/run-scout.js. Returns a ScoutOutput JSON object. Read-only; never edits tests or fixtures.",
