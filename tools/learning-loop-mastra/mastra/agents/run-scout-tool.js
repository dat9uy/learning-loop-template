/**
 * createTool wrapper over tools/learning-loop-mastra/scout/pipeline/run-scout.js#runScout.
...
import { z } from "zod";
import { runScout } from "../../scout/pipeline/run-scout.js";

export const runScoutTool = createLoopTool({
  id: "run_scout",
  description:
    "Run the scout pipeline at tools/learning-loop-mastra/scout/pipeline/run-scout.js. Returns a ScoutOutput JSON object. Read-only; never edits tests or fixtures.",
