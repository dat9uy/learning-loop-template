...
3. Invoke the runScout tool (a createTool(...) wrapper exposing tools/learning-loop-mastra/scout/pipeline/run-scout.js#runScout) with input shape { projectRoot: string, excludeGlobs?: string[] }. The tool must call the pure function directly — no test file edits, no fixture edits, no file writes anywhere.
