...
| **Meta** | `tools/learning-loop-mcp/meta-state.jsonl` | System-level findings (agent decisions, reasoning, bug reports) | Agent (via MCP `meta_state_*` tools) | Ephemeral, 24h TTL |
