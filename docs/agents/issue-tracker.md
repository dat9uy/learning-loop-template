...
- **Blocking**: use GitHub’s native issue dependencies. Where unavailable, fall back to a `Blocked by: #<n>, #<n>` line.
- **Frontier query**: list the map’s open children, then exclude blocked or assigned tickets; first in map order wins.
